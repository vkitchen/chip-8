...
#define ISKEY(code) (code == SDLK_1 || code == SDLK_2 || code == SDLK_3 || code == SDLK_4 \
	|| code == SDLK_q || code == SDLK_w || code == SDLK_e || code == SDLK_r \
	|| code == SDLK_a || code == SDLK_s || code == SDLK_d || code == SDLK_f \
	|| code == SDLK_z || code == SDLK_x || code == SDLK_c || code == SDLK_v )
